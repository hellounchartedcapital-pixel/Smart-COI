...
Return a JSON object with exactly this structure:
{
  ...
  "additional_insured_name": "string or null — the entity that must be named as additional insured",
  "certificate_holder_name": "string or null — the entity that should receive certificates",
...
6. If you find per-occurrence AND aggregate limits for the same coverage (e.g., "$1M per occurrence / $2M aggregate"), create TWO separate entries.
7. Look for requirements about Additional Insured, Waiver of Subrogation, and Primary & Non-Contributory language.
...
9. Only return coverage types from the allowed enum values. Map common lease language:
