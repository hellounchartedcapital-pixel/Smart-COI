---
title: "How to Set Vendor & Tenant Insurance Requirements"
description: "Not sure what limits to require? Practical guide covering GL, auto, umbrella, workers comp, and additional insured requirements for commercial properties."
date: "2026-03-10"
...
Getting this wrong creates real exposure. Require too little and you are unprotected when something goes wrong — and [the costs can be substantial](/blog/cost-of-not-tracking-vendor-insurance). Require too much and you will struggle to attract vendors and tenants. The goal is to set requirements that are proportional to the risk each party brings to your property.
...
Being named as an [additional insured](/blog/what-is-additional-insured-commercial-real-estate) on a vendor's or tenant's policy gives your organization coverage under their policy. If someone sues both the vendor and the property owner over an incident, the vendor's insurance defends and indemnifies you as well.
...
5. **Track compliance systematically** rather than checking certificates only when they arrive. Consider [building a formal COI compliance policy](/blog/building-coi-compliance-policy-property-management) to ensure consistency.
